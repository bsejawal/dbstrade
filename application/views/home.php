<div class="sidebar_wrap">
    ...
    <div class="sidebar_cont">
        ...
        if (!empty($type)) {
            foreach ($type as $catagories) {
                ?>
                <div class="sidebar_buttons">&raquo; <a style="font-size: 12px;" href="home?category=<?php echo $catagories['category']; ?>"><?php echo $catagories['category']; ?></a></div>
                <?php
            }
        } else {
    ...
    <script>
        $(function () {
            $("#carousel").carouFredSel({responsive: true, items: {visible: 1, width: 694, height: 300}, scroll: {duration: 250, timeoutDuration: 2500, fx: "uncover-fade"}, pagination: "#pager"});
            (function (e, t, n) {
...
<div class="content_wrap">
            ...
            foreach ($productData as $prods) {
                ...
                <div class="panel panel-default panel_override">
                    ...
                    <div class="panel-body panel-body_override">
                        <div class="image_area"><img src="<?php echo $prods['imgPath']; ?>" class="prodImg" onclick="readMore(<?php echo $prods['id'] ?>);"></div>
                        <button type="button" class="btn btn-default pnl_btn_override" onclick="bookProduct(0, '<?php echo $prods['id']; ?>');">Book Product</button>
                    </div>
                </div>
                <?php
            }
    ...
    <?php if (!empty($productData)) { ?>
        <nav style="text-align: right;">
            <ul class="pagination" >
                <?php if ($prods['page'] == 1) { ?>
                    <li><a href="javascript:void(0)" id="paginationOverrideDisable">&laquo;</a></li>
                <?php } else { ?>
                    <li><a href="home?page=<?php echo $prods['page'] - 1; ?>" id="paginationOverride">&laquo;</a></li>
                <?php } if ($prods['page'] == $num_page) { ?>
                    <li><a href="javascript:void(0)" id="paginationOverrideDisable">&raquo;</a></li>
                <?php } else { ?>
...
<div class="popupBackground" id="readMoreBack">
    <div class="popup" id="readMoreCont">
        <div class="headings"><span id="title"></span><a href="javascript:void(0)" id="readMoreClose" class="close_btn">X</a></div>
