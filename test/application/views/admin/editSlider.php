<div class="admin_edit_center">
    <div style="border: 1px solid black;width: 702px; float: left; display: table-cell; margin-right: 20px;"><img src="<?php echo base_url() ?>images/uploads/<?php echo $imageName; ?>" id="cropbox" style="width: 700px;" /></div>
    <h4>Tips:</h4>
    <ol>
